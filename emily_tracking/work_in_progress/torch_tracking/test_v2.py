...
if __name__ == "__main__":
    ...
    test_tp = False
    full_df = []
    for frame_start, chunk in chunker:
        # if test_tp:
        ...
        test = torch_tracking_v2.locate(tvid, params.static_object_size, separation = params.static_sep, padded_vid = tpadded_vid, params = params,
         minmass = 300)
        print(f"This iteration took {time() - each}")
        
        # test["frame"] += frame_start
        full_df.append(test)
        del tvid
        del chunk
