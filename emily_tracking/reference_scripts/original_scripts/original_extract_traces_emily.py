...
#        tp.annotate(f, video_still)
        ...
        fig.tight_layout()
        fig.savefig(str(save_path+str(counter)+'_/'+"full_locate_loc"+'.pdf'))
        fig.savefig(str(save_path+str(counter)+'_/'+"full_locate_loc"+'.png'))
...
#
        ...
        ax.plot(f.x.values,f.y.values,'.',color = "red",alpha =0.5)
        fig.tight_layout()
        fig.savefig(str(save_path+str(counter)+'_/'+"full_locate"+'.pdf'))
        fig.savefig(str(save_path+str(counter)+'_/'+"full_locate"+'.png'))
        ...
        full.to_csv(str(save_path+str(counter)+'_/'+'_signal_df.csv'), header=True, index=None, sep=',', mode='w')

        ## new
        if not os.path.exists(str(save_path+str(counter)+'_/')):                      # creates a folder for saving the stuff in if it does not exist
            os.makedirs(str(save_path+str(counter)+'_/'))
        with open(str(save_path+str(counter)+'_/'+'rois.txt'), "w") as text_file:
...
#new end
        ...
        for par,dat in grp:
            ...
            fig.tight_layout()
            fig.savefig(str(save_path+str(counter)+'_/'+str(par)+'.png'))
            plt.close('all')
        ...
        ax.legend()
        fig.tight_layout()
        fig.savefig(str(save_path+str(counter)+'_/'+'corrected_hist.pdf'))
        ...
        ax.legend()
        fig.tight_layout()
        fig.savefig(str(save_path+str(counter)+'_/'+'gausscorrected_hist.pdf'))
        ...
        ax.legend()
        fig.tight_layout()
        fig.savefig(str(save_path+str(counter)+'_/'+'set_zero_hist.pdf'))
        ...
        ax.legend()
        fig.tight_layout()
        fig.savefig(str(save_path+str(counter)+'_/'+'raw_hist.pdf'))
...
if __name__ == "__main__":
    ...
    #                  '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_004_20220301.tif',
    #                  '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_006_20220301.tif',
    #                  '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_009_20220301.tif',
    #                  '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_011_20220301.tif',
    #                  '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_014_20220301.tif']


    # protease signal, 2000 frames videos
    video_signal = [rf"{drive_name}\Emily\_20220831\Tifs\s_20.tif"]
    #                '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_005_20220301.tif',
    #                '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_007_20220301.tif',
    #                '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_010_20220301.tif',
    #                '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_012_20220301.tif',
    #                '/Volumes/Min Zhang/protease/20220301/20220301 casein+savinase/Folder_20220301/Experiment_Process_015_20220301.tif']


    save_path = (fr"{drive_name}\Emily\_20220831\Tifs\savinase_traces\test_")
